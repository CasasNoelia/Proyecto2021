...
public class MascotaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnseleccionar, btnAcerptarImagen, btnEliminar, btnModificar, btnCancelar;
    Bitmap bitmap;
    Bitmap bit;
    dboMascotas dbo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnseleccionar = (Button) findViewById(R.id.Seleccionar);
    ...
    public void RegsistarMascota(Mascota mas){
        try {
            ...
            if (tipomascota.getText().toString().isEmpty() || departamento.getText().toString().isEmpty() || description.getText().toString().isEmpty()){
